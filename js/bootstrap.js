...
+function ($) {
  ...
  Tooltip.prototype.getOptions = function (options) {
    options = $.extend({}, this.getDefaults(), this.$element.data(), options)
      ...
      * options = {
      *   arrow : true, //是否有小三角
      *   className : "" //自定义popover结构样式名，如果未定义，则沿用默认样式
      * }*/
      options.arrow === false && typeof options.arrow === "boolean"? options.template = '<div class="popover" role="tooltip"><h3 class="popover-title"></h3><div class="popover-content"></div></div>' :  options.template;
      //
